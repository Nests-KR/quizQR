...
function checkShortAnswer(question, input) {
    ...
    if (isCorrect) {
        ...
        // Create and display the correct answer
        const correctAnswerElement = document.createElement('div');
        correctAnswerElement.innerText = `정답: ${question.answer}`;
        correctAnswerElement.classList.add('correct-answer-display');
        answerButtonsElement.appendChild(correctAnswerElement);
    }
